...
python ${mydir}/zmmgScale.py $1 -o $2/split_ebee   \
    -g "0,1,4,5" -l "EB" -g "2,3,6,7" -l "EE"
python ${mydir}/zmmgScale.py $1 -o $2/split_hilopt \
    -g "0,1" -l "EBHighPt" -g "2,3" -l "EBLowPt" \
    -g "4,5" -l "EEHighPt" -g "6,7" -l "EELowPt"
python ${mydir}/zmmgScale.py $1 -o $2/split_hilor9 \
    -g "0,4" -l "EBHighR9" -g "1,5" -l "EBLowR9" \
    -g "2,6" -l "EEHighR9" -g "3,7" -l "EELowR9" 
